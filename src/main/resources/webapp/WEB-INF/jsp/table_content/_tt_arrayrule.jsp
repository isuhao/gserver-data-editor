...
<table id="dg" title="数据表格" style="width:1000px;height:364px" toolbar="#toolbar" pagination="true" idField="id" rownumbers="true" fitColumns="true" singleSelect="true">
	<thead>
		<tr>
			...
			<th field="${columns[5].name}" width="50" editor="{type:'tableWindow', options:{divId:'popTableWin', table:'${tablename}', field:'${columns[5].name}', openTable:'_tt_constraint', openTableField:'code'}}">${columns[5].comment}</th>
